...
from dashboard_builder.components.layouts import ColumnLayout, ExpanderLayout # noqa: E402
...
def index():
    ...
    ## testing the Expander Layout
    expander_layout1 = ExpanderLayout(label='About the dataset...', id='test_expander', components=[output4, output5, output6, output7]) # noqa: E501
    ...
    manager.register_outputs(output1, output2, output3, 
                             expander_layout1, 
